...
const platformIconMap: Record<string, ReactNode> = {
  ...
  tiktok: <MessageCircle className="w-3.5 h-3.5" />,
  email: <MessageCircle className="w-3.5 h-3.5" />,
};
      ...
      <div className="p-4 border-b border-white/[0.05]">
        <div className="relative">
          ...
          <input
            ...
            className="w-full pl-12 pr-4 py-2.5 rounded-xl bg-white/[0.04] border border-white/[0.08] text-sm text-white placeholder:text-white/40 focus:outline-none focus:border-white/20 transition-colors"
          />
        </div>
      </div>
        ...
        {filtered.map((conversation) => {
          ...
          return (
            <button
              ...
              className={cn(
                "w-full text-left px-4 py-3 flex items-center gap-3 border-b border-white/[0.02] hover:bg-white/[0.04]",
            ...
            >
              <div className="relative">
                ...
                {conversation.unreadCount > 0 && (
                  <span className="absolute -top-1 -right-1 w-5 h-5 rounded-full bg-rose-500 text-[11px] font-semibold text-white flex items-center justify-center">
