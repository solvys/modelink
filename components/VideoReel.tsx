  ...
  return (
    <>
      <div className="w-full">
        <h2 className="text-3xl font-bold mb-6 text-gray-900 dark:text-white">Video Reel</h2>
        <div className="flex gap-4 overflow-x-auto pb-4 snap-x snap-mandatory scrollbar-hide">
          {videos.map((video, index) => {
            ...
            return (
              ...
              >
                <div className="relative aspect-video rounded-xl overflow-hidden bg-soft-gray shadow-medium">
                  {thumbnail ? (
                    <img
                      src={thumbnail}
                      alt={video.title}
